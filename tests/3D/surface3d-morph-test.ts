// Torus to Sphere Morph Animation
...
// Slerp morph function for smooth surface transitions
const slerpMorph = (
...
// Surface — checkerboard with two distinct colors
...
async function runAnimation() {
  ...
  // Phase 0: Fade in axes
  scene.at(0).play(fadeIn(axes, { duration: 1 }));
  ...
  console.log('[Torus-Sphere Morph Test] Animation loaded!');
  console.log('- Phase 1: Sphere → Torus (0-3s)');
  console.log('- Phase 2: Torus → Sphere (3-6s)');
  console.log('- Camera orbits continuously');
